...
A *derivative* (slope of a line) is measuring how sensitivity of a function's output with respect to it's input. In other words, it measures the *steepness* of the graph of a function.
